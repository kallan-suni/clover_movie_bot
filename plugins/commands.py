...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('⍟ 𝗨𝗉𝖽𝖺𝗍𝖾𝗌', url=f'https://t.me/cinema_flix_updates')
            ],[
...
async def settings(client, message):
    ...
    if settings is not None:
        buttons = [[
            ...
            InlineKeyboardButton('𝗙𝗂𝗅𝗍𝖾𝗋 𝗕𝗎𝗍𝗍𝗈𝗇', callback_data=f'setgs#button#{settings["button"]}#{str(grp_id)}'),
            InlineKeyboardButton('𝗦𝗂𝗇𝗀𝗅𝖾' if settings["button"] else '𝗗𝗈𝗎𝖻𝗅𝖾',  callback_data=f'setgs#button#{settings["button"]}#{str(grp_id)}')
            ],[
            ...
            InlineKeyboardButton('✅ 𝗘𝗇𝖺𝖻𝗅𝖾' if settings["file_secure"] else '🚫 𝗗𝗂𝗌𝖺𝖻𝗅𝖾',  callback_data=f'setgs#file_secure#{settings["file_secure"]}#{str(grp_id)}')
            ],[
            InlineKeyboardButton('𝗜𝗆𝖽𝖻 𝗣𝗈𝗌𝗍𝖾𝗋', callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}'),
            InlineKeyboardButton('✅ 𝗘𝗇𝖺𝖻𝗅𝖾' if settings["imdb"] else '🚫 𝗗𝗂𝗌𝖺𝖻𝗅𝖾', callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}')
            ],[
            InlineKeyboardButton('𝗦𝗉𝖾𝗅𝗅 𝗖𝗁𝖾𝖼𝗄', callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}'),
            InlineKeyboardButton('✅ 𝗘𝗇𝖺𝖻𝗅𝖾' if settings["spell_check"] else '🚫 𝗗𝗂𝗌𝖺𝖻𝗅𝖾', callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}')
            ],[
            InlineKeyboardButton('𝗪𝖾𝗅𝖼𝗈𝗆𝖾 𝗠𝗌𝗀', callback_data=f'setgs#welcome#{settings["welcome"]}#{str(grp_id)}'),
            InlineKeyboardButton('✅ 𝗘𝗇𝖺𝖻𝗅𝖾' if settings["welcome"] else '🚫 𝗗𝗂𝗌𝖺𝖻𝗅𝖾', callback_data=f'setgs#welcome#{settings["welcome"]}#{str(grp_id)}')               
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_text(
